...
const NativePlants = () => {
  return (
    ...
    <DetailProject
        ...
        skill2={"UX/UI Design"}
        skill3={"Three.js"}
        goal1={"Practice key UX/UI design principles such as user testing and wireframing"}
        goal2={"Learn a new JavaScript library and implement it in a meaningful manner"}
        goal3={"Create an aestheically pleasing and easy to use website"}
